...
| `source`                        | Data source for each oxidation record. `Tom_ini` denotes initial experimental data generated by the authors’ laboratory, whereas DOI links indicate data collected from published literature.                                                                      |
