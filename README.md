...
The database comprises **886 oxidation records**, including data extracted from published literature and initial in-house experimental data generated by the authors’ laboratory. The dataset contains **62 DOI-based literature sources** and one in-house source labelled as `Tom_ini`. The value `Tom_ini` is not counted as a literature source.
